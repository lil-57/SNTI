...
export function CallToAction({ title, description, buttonText, buttonLink }: CallToActionProps) {
  return (
    <section className="py-12 sm:py-16 lg:py-24 bg-emerald-50 relative overflow-hidden">
      ...
      >
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button
              asChild
              className="bg-emerald-600 hover:bg-emerald-700 rounded-full px-6 sm:px-8 py-4 sm:py-6 text-sm sm:text-base inline-flex items-center justify-center"
            >
